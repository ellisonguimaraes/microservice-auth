        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 450, nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EditedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    EditedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUser", x => new { x.UserId, x.ApplicationId });
                    table.ForeignKey(
